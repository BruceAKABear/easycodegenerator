...
import pro.dengyi.easycodegenerator.entity.DataBase;
import pro.dengyi.easycodegenerator.entity.Settings;
import pro.dengyi.easycodegenerator.entity.Table;
import pro.dengyi.easycodegenerator.utils.DataBaseUtils;
import pro.dengyi.easycodegenerator.utils.PropertiesUtils;
...
/**
 * 1.采集用户UI界面输入的数据 模板位置 代码生成路径 工程配置对象 setting 数据库对象 DataBase 2.准备数据模型 1.自定义配置 2.元数据 3.setting
 * 3.调用核心处理类完成代码生成工作 方法：Generator
 */
