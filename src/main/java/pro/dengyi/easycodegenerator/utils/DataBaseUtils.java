...
import pro.dengyi.easycodegenerator.entity.Column;
...
public class DataBaseUtils {
   ...
   *
   * <p>1.参数 DataBase 数据库对象 2.操作步骤 1.获取连接 2.获取databasemetaData 3.获取当前数据库中的所有表 4.获取每个表中的所有字段
   * 5.封装到java对象中即可
   */
  public static List<Table> getDbInfo(DataBase db) throws Exception {
    ...
    while (tables.next()) {
      ...
      while (columns.next()) {
        ...
        // 列名称
        String columnName =
            columns.getString("COLUMN_NAME"); // user_id  userId , create_time createTime
